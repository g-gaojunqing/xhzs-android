...
/**
  ...
  * @param  Rank: The rank in the regular group sequencer. This parameter must be between 1 to 16.//多通扫描时，此通道的顺序
  * @param  ADC_SampleTime: The sample time value to be set for the selected channel. 
  *   This parameter can be one of the following values:
  *     @arg ADC_SampleTime_1Cycles5: Sample time equal to 1.5 cycles//采样周期，周期--ADCCLK
